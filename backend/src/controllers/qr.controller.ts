...
export class QRController {
  ...
  async generateQR(req: Request, res: Response): Promise<Response | void> {
    try {
      ...
      if (error instanceof z.ZodError) {
        ...
        logger.error('QR generation error', { error: error.message, stack: error.stack, orderId: req.body.orderId });
  ...
  async verifyPayment(req: Request, res: Response): Promise<Response | void> {
    try {
      ...
      logger.error('Payment verification error', { error: error.message, stack: error.stack, orderId: req.body.orderId });
