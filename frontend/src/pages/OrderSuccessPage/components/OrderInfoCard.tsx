...
export const OrderInfoCard: React.FC<OrderInfoCardProps> = ({
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 mb-6 animate-scale-in" style={{ animationDelay: '0.2s' }}>
      ...
      <div className="space-y-4">
        ...
        <div className="flex justify-between items-center py-3 mt-4">
          ...
          <span className="text-2xl font-bold text-orange-500">{formatCurrency(orderDetails.total)}</span>
        </div>
      </div>
