...
import stockService, { type CreateIngredientInput, type UpdateIngredientStockInput } from '@services/stock.service.ts';
import type { StockIngredient, StockTransaction, StockAlert } from '@services/stock.service.ts';
