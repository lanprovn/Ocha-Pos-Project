...
const ProductCard: React.FC<ProductCardProps> = memo(({ product, onClick, onQuickAdd }) => {
  ...
  return (
    <div
      onClick={onClick}
      className="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden cursor-pointer min-h-[44px] min-w-[44px] group relative"
    >
      ...
      <div className="relative h-48 overflow-hidden bg-gray-100">
        ...
        {isCustomerDisplay && onQuickAdd && (
          <button
            ...
            className="absolute bottom-2 right-2 w-10 h-10 bg-emerald-500 hover:bg-emerald-600 rounded-full flex items-center justify-center shadow-lg z-10 text-white transition-all duration-200 hover:scale-110"
